  ...
  <div class="preponse-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="card-body">
            <h5 class="card-title mt-5 fw-semibold mb-4">Modifier une question</h5>
            <div class="mt-5 card">
              <div class="card-body">
                <form action="" id="formr" method="post">
                  <div class="mb-3">
                    <label class="form-label">Question :</label>
                    <input type="text" value="<?= $question['question'] ?>" class="form-control" id="question" name="question">
                    <span id="questionr"></span>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Option 1 :</label>
                    <input type="text" value="<?= $question['r1'] ?>" class="form-control" id="r1" name="r1">
                    <span id="r1r"></span>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Option 2 :</label>
                    <input type="text" value="<?= $question['r2'] ?>" class="form-control" id="r2" name="r2">
                    <span id="r2r"></span>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Option 3 :</label>
                    <input type="text" value="<?= $question['r3'] ?>" class="form-control" id="r3" name="r3">
                    <span id="r3r"></span>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Reponse :</label>
                    <input type="text" class="form-control" value="<?= $question['reponse'] ?>" id="reponse" name="reponse">
