  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="card-body">
            <h5 class="card-title mt-5 fw-semibold mb-4">Modifier un cours</h5>
            <div class="mt-5 card">
              <div class="card-body">
                <form action="" id="formr" method="post">
                  <div class="mb-3">
                    <label class="form-label">Nom :</label>
                    <input type="text" value="<?= $cours['nom'] ?>" class="form-control" id="nom" name="nom">
                    <span id="nomr"></span>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">cours :</label>
                    <input type="text" value="<?= $cours['cour'] ?>" class="form-control" id="cour" name="cour">
                    <span id="courr"></span>
                  </div>
                  <div class="mb-3">
    ...
    <script>
      ...
      myform.addEventListener('submit', function(e) {
        ...
        if (cour.value === '') {
          ...
          courr.innerHTML = "le champs prenom est vide . ";
          courr.style.color = 'red';
          e.preventDefault();
        } else if (!(regex.test(cour.value))) {
          let courr = document.getElementById('nomr');
          courr.innerHTML = "le prenom doit comporter des lettres,et tirets seulements.";
          courr.style.color = 'red';
          e.preventDefault();
        }
        if (nameinput.value === '') {
